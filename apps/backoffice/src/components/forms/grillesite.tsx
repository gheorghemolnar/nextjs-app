...
//     useForm,
// } from '@big/forms';
// import { IResponseRO, PARAMSITE } from '@big/types';
...
//     idsecteur: z
//         .string()
//         .min(1, { message: 'Veuillez séléctionnez le secteur.' }),
// });
...
// export default function ParameterSiteForm() {
...
//         const response = await fetch(`${URL_BASE}/api/utilisateurssateurs`, {
//             method  : 'POST',
//             headers : {
...
//                                 <SelectContent>
//                                     <SelectItem value="1">
//                                         1ère transformation Boeuf
//                                     </SelectItem>
//                                     <SelectItem value="2">
//                                         2ème transformation Boeuf
//                                     </SelectItem>
//                                     <SelectItem value="3">
//                                         1ère transformation Porc
//                                     </SelectItem>
//                                     <SelectItem value="4">
//                                         2ème transformation Porc
//                                     </SelectItem>
//                                     <SelectItem value="5">
//                                         3ème transformation
//                                     </SelectItem>
