...
import { AccordionDemo } from "./tmp/acc-demo";
...
const Sidebar = ({
  ...
  return (
    <div
      className={clsx({
        "bg-red-700 text-zinc-50 fixed md:static md:translate-x-0 z-20": true,
          ...
          <div className="flex gap-4 h-11 overflow-hidden">
            ...
            {!collapsed && (
              <div className="flex flex-col ">
                <span className="text-indigo-50 my-0">Utilisateur</span>
                {/*
